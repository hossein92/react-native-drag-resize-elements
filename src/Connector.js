    ...
    return (
      <View
        style={{
          ...
          backgroundColor: type=== 'c' ? '#fff0' :'#0004',
          borderRadius : type === 'c' ? undefined : size,
          alignItem:'center',
      ...
      >
       {type === 'c' ? null :  <Image style={{width:'100%' , height :'100%' }} resizeMode={'contain'} source={require('../resize.png') }/>}
      </View>
    );
  }
}
